...
document.getElementById("frd1").textContent = names[
  Math.floor(Math.random() * names.length)
];
document.getElementById("frd2").textContent = names[
  Math.floor(Math.random() * names.length)
];
document.getElementById("frd3").textContent = names[
  Math.floor(Math.random() * names.length)
];
...
document.getElementById("generate").addEventListener("click", function(){
  ...
  document.getElementById("frd1").textContent = names[Math.floor(Math.random() * names.length)];
  document.getElementById("frd2").textContent = names[Math.floor(Math.random() * names.length)];
  document.getElementById("frd3").textContent = names[Math.floor(Math.random() * names.length)];
